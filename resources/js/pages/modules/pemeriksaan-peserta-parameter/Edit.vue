...
const breadcrumbs = [
    ...
    { title: 'Edit Parameter Peserta', href: `/pemeriksaan/${pemeriksaan.value.id}/peserta/${peserta.value.id}/parameter/${item.value.id}/edit?jenis_peserta=${jenisPeserta.value}` },
];
</script>

<template>
    <PageEdit title="Parameter Peserta" :breadcrumbs="breadcrumbs" :back-url="`/pemeriksaan/${pemeriksaan.id}/peserta/${peserta.id}/parameter?jenis_peserta=${jenisPeserta}`">
