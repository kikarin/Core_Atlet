...
const breadcrumbs = [
    ...
    { title: 'Tambah Parameter Peserta', href: `/pemeriksaan/${pemeriksaan.value.id}/peserta/${peserta.value.id}/parameter/create?jenis_peserta=${jenisPeserta.value}` },
];
</script>

<template>
    <PageCreate title="Tambah Parameter Peserta" :breadcrumbs="breadcrumbs" :back-url="`/pemeriksaan/${pemeriksaan.id}/peserta/${peserta.id}/parameter?jenis_peserta=${jenisPeserta}`">
