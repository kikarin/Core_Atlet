...
const breadcrumbs = computed(() => [
  ...
  { title: 'Create', href: `/tenaga-pendukung/${props.tenagaPendukungId}/prestasi/create` },
]);
</script>

<template>
    <PageCreate
        title="Buat Prestasi Tenaga Pendukung"
        :breadcrumbs="breadcrumbs"
        :back-url="`/tenaga-pendukung/${props.tenagaPendukungId}/prestasi`"
    >
        <Form :tenaga-pendukung-id="props.tenagaPendukungId" mode="create" />
    </PageCreate>
</template> 