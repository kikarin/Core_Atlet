...
const breadcrumbs = [
  ...
  { title: 'Detail Sertifikat', href: `/tenaga-pendukung/${props.tenagaPendukungId}/sertifikat/${props.item.id}` },
];
...
const handleEdit = () => {
  router.visit(`/tenaga-pendukung/${props.tenagaPendukungId}/sertifikat/${props.item.id}/edit`);
};

const handleDelete = () => {
  router.delete(`/tenaga-pendukung/${props.tenagaPendukungId}/sertifikat/${props.item.id}`, {
    onSuccess: () => {
