...
const breadcrumbs = [
    ...
    { title: 'Riwayat Pemeriksaan', href: `/tenaga-pendukung/${tenagaPendukung.value.id}/riwayat-pemeriksaan` },
    { title: 'Detail Parameter', href: `/tenaga-pendukung/${tenagaPendukung.value.id}/riwayat-pemeriksaan/${pemeriksaan.value.id}/parameter` },
];
        ...
        <div class="min-h-screen bg-gray-100 dark:bg-neutral-950 space-y-4 p-4">
            ...
            <div class="flex items-center justify-between ml-1">
                <div class="flex items-center gap-4">
                    <div>
                        <h1 class="text-2xl font-bold">Riwayat parameter pemeriksaan tenaga pendukung</h1>
                        <p class="text-muted-foreground">Riwayat parameter pemeriksaan tenaga pendukung</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Informasi Tenaga Pendukung</CardTitle>
                    </CardHeader>
                    <CardContent>
