        ...
        <Dialog v-model:open="showImportModal">
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Upload file Excel (.xlsx atau .xls) yang berisi data tenaga pendukung.
                    </DialogDescription>
                </DialogHeader>
                <div class="space-y-4">
                    <div class="space-y-2">
                    ...
                    <div class="rounded-lg border bg-muted p-3">
                        ...
                        <div class="text-xs text-muted-foreground space-y-1">
                            <div><strong>Tenaga Pendukung:</strong> nik, nama, jenis_kelamin, tempat_lahir, tanggal_lahir, alamat, kecamatan_id, kelurahan_id, no_hp, email, is_active</div>
