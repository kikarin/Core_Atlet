...
const breadcrumbs = [
    ...
    { title: 'Karakteristik', href: '/tenaga-pendukung/karakteristik' },
];
...
const fetchKarakteristik = async () => {
    loading.value = true;
    try {
        const response = await axios.post('/tenaga-pendukung/api-karakteristik', {
...
<template>
    <Head title="Karakteristik Tenaga Pendukung" />
        ...
        <div class="space-y-6 p-6">
            ...
            <Card>
                <div class="flex flex-col gap-4 p-6 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div>
                        ...
                        <CardDescription> Pilih rentang tanggal untuk menganalisis data karakteristik tenaga pendukung </CardDescription>
                    </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription> Tabel detail karakteristik tenaga pendukung berdasarkan kategori </CardDescription>
                </CardHeader>
                <CardContent>
