    ...
    <Dialog v-model:open="showDeleteDialog">
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Apakah Anda yakin ingin menghapus sertifikat <b>{{ rowToDelete?.nama_sertifikat }}</b>? Tindakan ini tidak dapat dibatalkan.
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
    ...
    <Dialog v-model:open="showDeleteSelectedDialog">
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Apakah Anda yakin ingin menghapus <b>{{ idsToDelete.length }}</b> sertifikat terpilih? Tindakan ini tidak dapat dibatalkan.
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
