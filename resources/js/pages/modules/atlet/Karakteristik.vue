        ...
        <div class="space-y-6 p-6">
            ...
            <Card>
                <div class="flex flex-col gap-4 p-6 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div>
                        ...
                        <CardDescription> Pilih rentang tanggal untuk menganalisis data karakteristik atlet </CardDescription>
                    </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription> Tabel detail karakteristik atlet berdasarkan kategori </CardDescription>
                </CardHeader>
                <CardContent>
