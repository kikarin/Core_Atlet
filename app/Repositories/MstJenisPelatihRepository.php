...
class MstJenisPelatihRepository
{
    use RepositoryTrait;
    protected $model;
    protected $request;

    public function __construct(MstJenisPelatih $model)
    {
        $this->model   = $model;
    ...
    public function handleShow($id)
    {
        ...
        return \Inertia\Inertia::render('modules/data-master/jenis-pelatih/Show', [
            'item' => $itemArray,
        ]);
    }
