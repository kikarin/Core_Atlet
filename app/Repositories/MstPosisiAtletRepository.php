...
class MstPosisiAtletRepository
{
    use RepositoryTrait;
    protected $model;
    protected $request;

    public function __construct(MstPosisiAtlet $model)
    {
        $this->model   = $model;
    ...
    public function handleShow($id)
    {
        ...
        return \Inertia\Inertia::render('modules/data-master/posisi-atlet/Show', [
            'item' => $itemArray,
        ]);
    }
