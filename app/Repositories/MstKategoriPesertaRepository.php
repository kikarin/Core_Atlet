...
class MstKategoriPesertaRepository
{
    use RepositoryTrait;
    ...
    public function __construct(MstKategoriPeserta $model)
    {
        $this->model   = $model;
    ...
    public function customIndex($data)
    {
        ...
        if ($perPage === -1) {
            ...
            $data += [
                'kategori_pesertas' => $transformedData,
    ...
    public function handleShow($id)
    {
        ...
        return \Inertia\Inertia::render('modules/data-master/kategori-peserta/Show', [
            'item' => $itemArray,
        ]);
    }
