...
class MstKategoriAtletRepository
{
    use RepositoryTrait;
    ...
    public function __construct(MstKategoriAtlet $model)
    {
        $this->model   = $model;
    ...
    public function customIndex($data)
    {
        ...
        if ($perPage === -1) {
            ...
            $data += [
                'kategori_atlets' => $transformedData,
    ...
    public function handleShow($id)
    {
        ...
        return \Inertia\Inertia::render('modules/data-master/kategori-atlet/Show', [
            'item' => $itemArray,
        ]);
    }
